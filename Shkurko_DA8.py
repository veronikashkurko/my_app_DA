...
Original file is located at
    https://colab.research.google.com/drive/1y2AMCTI6YvgidGIdOjldR_zgUzWqNCqQ

1. Завантаження бібліотек та датасету
"""
...
"""Додамо слайдер, що буде фільтрувати країни по кількості населення"""
...
"""Створимо чекбокс, що вмикатиме та вимикатиме карту"""
...
"""Основна панель Streamlit-додатку"""
